...
class SupplierProformaFilterSearchBar extends StatelessWidget {
  const SupplierProformaFilterSearchBar({super.key});
      ...
      child: Row(children: [
        Expanded(child: StandardSearchInput(
          onSearch: (context, keyword) {
            context.read<SuppliersProformasListBloc>().add(SearchInputChangedEvent(keyword: keyword));
          },
        )),
      ]),
    );
