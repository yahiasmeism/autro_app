...
class SupplierInvoiceFilterSearchBar extends StatelessWidget {
  const SupplierInvoiceFilterSearchBar({super.key});
      ...
      child: Row(children: [
        Expanded(child: StandardSearchInput(
          onSearch: (context, keyword) {
            context.read<SuppliersInvoicesListBloc>().add(SearchInputChangedEvent(keyword: keyword));
          },
        )),
      ]),
    );
