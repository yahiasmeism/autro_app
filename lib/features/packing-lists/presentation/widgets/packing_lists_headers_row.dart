...
class PackingListsHeadersRow extends StatelessWidget {
  const PackingListsHeadersRow({super.key});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 16),
          _buildHeaderCell('Total Weight', 4),
          const SizedBox(width: 16),
          _buildHeaderCell('Containers count', 4),
          const SizedBox(width: 16),
          _buildHeaderCell('Details', 4),
          const SizedBox(width: 16),
