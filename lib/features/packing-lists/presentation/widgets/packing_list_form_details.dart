                      ...
                      children: [
                        if (state.onePackingTypeForAll) ...[
                          StandardSelectableDropdown(
                            ...
                            onChanged: (p0) {
                              for (int i = 0; i < state.goodDescriptionsDTOsList.length; i++) {
                                final description = state.goodDescriptionsDTOsList[i].copyWith(type: p0).toControllersDTO();
                                bloc.updateGoodDescription(description);
                              }
                            },
