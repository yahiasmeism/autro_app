...
class NoDataScreen extends StatelessWidget {
  ...
  factory NoDataScreen.shippingInvoices() => const NoDataScreen(
        text: 'No Shipping Invoices',
        icon: Icons.receipt,
      );
  factory NoDataScreen.blInstructions() => const NoDataScreen(
        text: 'No BL Instructions',
        icon: Icons.receipt,
      );
  ...
  factory NoDataScreen.packingLists() => const NoDataScreen(
